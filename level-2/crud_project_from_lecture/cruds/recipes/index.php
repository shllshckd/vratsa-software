...
if (mysqli_num_rows($result) > 0) {
    ...
    <p>
        ...
        <a class="btn btn-sm btn-primary <?= ($page >= $max_pages) ? 'disabled' : '' ?>"
           href="index.php?page=<?= ($page < $max_pages) ? (($page + 1) . $filters_link_for_pagination) : $page . $filters_link_for_pagination ?>"><i
                    class='fa fa-arrow-right' aria-hidden='true'></i>Next</a>
